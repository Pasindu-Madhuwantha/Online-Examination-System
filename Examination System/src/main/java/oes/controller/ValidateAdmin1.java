 ...
 */
@WebServlet("/oes.controller.ValidateAdmin1")
public class ValidateAdmin1 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ValidateAdmin1() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    {
	    	String msg2 = "Invalid Username or Password New Wokr";
	    	response.sendRedirect("index2.jsp?msg2="+msg2);
	    }
