...
%><div height="300" width=100% style="background-color: yellow">
		<pre>
			<h1>
				<center>
...
%>
		...
		<thead>
			<tr class="table-warning">
				<th colspan="3" scope="col"><center>
						<pre>
							<h4>Name:-<%=session.getAttribute("name") %>  || Userid:-<%=session.getAttribute("username") %></h4>
						</pre>
					</center></th>
			</tr>
		</thead>
	...
	<center>
		<input onclick="location.href='oes.controller.LogoutStudent'"
